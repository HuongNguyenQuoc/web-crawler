...
class Url(Base):
    ...
    status: Mapped[UrlStatus] = mapped_column(String(32), default=UrlStatus.PENDING, nullable=False)
    ...
    __table_args__ = (
        ...
        Index("idx_url_content_hash", "content_hash"),  # The "hash (GSI)" in the diagram, used for content-level deduplication
        Index("idx_url_status", "status"),
...
class Domain(Base):
    ...
    crawl_delay_ms: Mapped[int] = mapped_column(BigInteger, default=1000, nullable=False)
